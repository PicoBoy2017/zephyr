...
static int udc_max32_lock(const struct device *dev)
{
	return udc_lock_internal(dev, K_FOREVER);
}

static int udc_max32_unlock(const struct device *dev)
{
...
#define UDC_MAX32_DEVICE_DEFINE(n)                                                                 \
	...
	static const struct udc_max32_config udc_max32_config_##n = {                              \
		...
		.irq_func = &udc_max32_irq_init_##n,                                               \
                                                                                                   ...
                                                                                                   \
	static MXC_USB_Req_t *ep_request_##n[DT_INST_PROP(n, num_bidir_endpoints)];                \
                                                                                                   \
