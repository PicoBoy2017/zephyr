...
elseif(CONFIG_SOC_MAX32655_RV32)
  set(MAX32_TARGET_CFG "max32655_riscv.cfg")
  set(MAX32_INTERFACE_CFG "olimex-arm-usb-ocd-h.cfg")
elseif(CONFIG_SOC_MAX32657)
  set(MAX32_TARGET_CFG "max32657.cfg")
...
elseif(CONFIG_SOC_MAX32690_RV32)
  set(MAX32_TARGET_CFG "max32690_riscv.cfg")
  set(MAX32_INTERFACE_CFG "olimex-arm-usb-ocd-h.cfg")
elseif(CONFIG_SOC_MAX78002_M4)
  set(MAX32_TARGET_CFG "max78002.cfg")
elseif(CONFIG_SOC_MAX78002_RV32)
  set(MAX32_TARGET_CFG "max78002_riscv.cfg")
  set(MAX32_INTERFACE_CFG "olimex-arm-usb-ocd-h.cfg")
endif()
